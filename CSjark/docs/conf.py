# -*- coding: utf-8 -*-
#
# CSjark documentation build configuration file, created by
...
if on_rtd:
    exclude_patterns = ['_build', 'devel/code.rst']
else:
...
man_pages = [
    ('index', 'csjark', u'CSjark Documentation',
     [u'Even Wiik Thomassen, Erik Bergersen, Sondre Johan Mannsverk, Terje Snarby, Lars Solvoll Tønder, Sigurd Wien & Jaroslav Fibichr'], 1)
]
