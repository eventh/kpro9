...
description={A program in Unix that enables the user to schedule the execution of command-line programs.}}
...
description={Automatic execution of a series of programs}}
