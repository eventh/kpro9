...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	& 3. Read the output\\
	\midrule
	\multirow{2}{*}{Expected result}  & 3. The user should be presented with some text expressing the failure of 0 assertions  \\
	\bottomrule
\end{tabularx}}
\end{table}
...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	Tester & Lars Solvoll Tønder \\
	Prerequisites & The utility has to be up and running \\
	Feature & Configuration must support specifying the ID of dissectors \\
	\midrule
...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	Tester & Lars Solvoll Tønder \\
	Prerequisites & The utility has to be up and running \\
	Feature & Command line shall support batch mode of C header and configuration files \\
	\midrule
	\multirow{5}{*}{Execution} & 1.  \\
	& 2.  \\
	& 3. \\
