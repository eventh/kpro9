...
%-----------------------
The test cases ran in sprint 1 are \autoref{tab:TID01}-\ref{tab:TID07}. 
...
%-----------------------
The testcases we ran in sprint 2 are \autoref{tab:TID08}-\ref{tab:TID14}. 
...
%-----------------------------
The testcases we ran in sprint 3 are \autoref{tab:TID15}-\ref{tab:TID23}. 
...
\section{Sprint 4}
%----------------------
The testcases ran in sprint 4 are \autoref{tab:TID26}-\ref{tab:TID47}.
