...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	\midrule
	\multirow{2}{*}{Execution} & 1.Feed the utility with the name of a folder of header files which again has subfolders with other header files\\
	& 2.  Read the output\\
...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	\midrule
	\multirow{2}{*}{Execution} & 1.NOT DONE YET\\
	& 2.  NOT DONE YET\\
	\midrule
	\multirow{1}{*}{Expected result}
	& 2. NOT DONE YET\\
