...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	Tester & Lars Solvoll Tønder \\
	Prerequisites & The utility has to have been installed on the system as well as the attest testing framework.The file black_box.py must also be present in the test folder of Csjark \\
