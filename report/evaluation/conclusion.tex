...
After finishing the product, the customer reviewed the utility and they were satisfied with what we had delivered. We managed to complete all of the initial functional- and all of the non-functional requirements. In addition we also completed all the functional requirements added by the customer before the last sprint.
