...
\begin{tabularx}{1.2\textwidth}{|l| X|}
	...
	\midrule
	Advisor contact & Responsible for distributing information between the group and the advisor. \\ 
	\midrule
...
The customer contacts are listed in table \ref{tab:part_cust}. The developers consists of seven student from NTNU, and are listed in table \ref{tab:part_dev}.  The project group has two advisors from  the Department of Computer and Information Science at NTNU, and are listed in table \ref{tab:part_adv}. \newline

\begin{table}[!ht] \footnotesize \center
\caption{Customers\label{tab:part_cust}}
\noindent\makebox{%
\begin{tabularx}{1.2\textwidth}{l l l}
	\toprule
	\textbf{Name} & \textbf{Mobile} & \textbf{E-mai}l  \\ 
	\midrule
...
\begin{tabularx}{1.2\textwidth}{l l l}
	\toprule
	\textbf{Name} & \textbf{Mobile} & \textbf{E-mail}  \\ 
	\midrule
