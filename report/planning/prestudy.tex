...
Waterfall~\cite{waterfall} is a software development methodology based on sequential phases.
...
%-----------------------
\label{sec:pre:scrum}
\Gls{scrum}~\cite{Rising2000} is an agile development methodology based on the philosophy that it is
