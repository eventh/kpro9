...
The listed actual work hours does not reflect the total hours used on
each requirement. Any fixes, improvements or refactoring done in a later
sprint is not included. Testing and user documentation is also not
considered.
