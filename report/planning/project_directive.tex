...
Before, when Thales wanted to debug inter-process communication with \Gls{wireshark}, they had to write the \glspl{dissector} manually. Their hope is therefore that our tool can save them valuable time.
