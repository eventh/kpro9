...
\noindent The customer gave also further descriptions for the following requirements. 
\paragraph{FR1-E: Support member of type array}
\Glspl{array} should be displayed as a sublevel. Multidimensional
\glspl{array} should have one sublevel per dimension. \Glspl{dissector} should
...
\begin{tabularx}{1.2\textwidth}{l X c c}
	...
	FR7-B & The utility shall support reading configuration for \#define enums from the header files & O & ? \\
	\bottomrule
\end{tabularx}}
\end{table}
...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	Summary & The administrator wants to generate a Lua-dissector based on a header file,  and maybe an associated configuration file. \\
	\multirow{2}{*}{Preconditions} & 1. The administrator have the utility and its dependent libraries installed.  \\
	& 2. The administrator have a header and configuration pair, which a Lua-dissector shall be made of. \\
