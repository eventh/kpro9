...
\begin{tabularx}{1.2\textwidth}{l X c c}
	...
	FR6-H & The utility shall support automatic generation of configuration files for unknown structs & ? & ? \\
	FR6-I & Configurtion must support specifying the size of a struct members & ? & ? \\
	\midrule
...
\begin{tabularx}{1.2\textwidth}{l X c c}
	...
	\midrule
	FR7 & Fetch configuration directly from source code & O & ? \\
