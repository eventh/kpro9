...
The customer want the utility to be able to take certain C preprocessor
...
The customer want Wireshark to be able to guess what dissectors to use
...
This is to avoid complex headers that are irrelevant to the customers goal
