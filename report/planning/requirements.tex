...
\begin{tabularx}{1.2\textwidth}{l X}
	\toprule
	 & \includegraphics[scale=0.6]{./planning/img/usecase1} \\
	\toprule
	Element & Description\\
	\midrule
	Brief description & The user would like to filter and search for attributes in the packets displayed in Wireshark \\
