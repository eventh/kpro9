...
\subsection{Sprint 4}
%----------------------
During sprint 4 it was finally decided how we were to test our non-functional requirements. A tool was also considered for checking the readability of the utility's code, but as we were unable to find one that worked for python version 3.2 and that at the same time suited the needs of the group, it was decided to use manual code inspection instead. 
