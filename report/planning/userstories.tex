...
The wireshark user is this context is the customer or debuggers of Thales Norway AS
...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	FR02A 	& As a wireshark user, I want that the dissector is able to display simple C structs.\\
	FR02B 	& As a wireshark user, I want that the dissector is able to display C struct, that contains other structs.\\
	FR02C 	& As a wireshark user, I want to use Wiresharks built-in filter and search on attributes, on the dissectors.\\
	FR02D 	& As a wireshark user, I want see when a there is a invalid value for a struct member\\
	\addlinespace
