...
look for struct definitions, which they will fill into the data-structures
that the back-end will use.

It should use pycparser and PLY libraries for parsing of C files. It should accept C
header files and create an abstract syntax tree, which it then traverses
to finds struct definitions and their members. The struct definitions and members
