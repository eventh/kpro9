...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	\addlinespace
	Execution & 1. Feed the utility with the name of a config file 
	\addlinespace
			2. Read the output\\
	\addlinespace
...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	\addlinespace
	Execution & 1. Feed the utility with the name of a header file that has structs with restrictions on them set in the config file.
	\addlinespace
