...
%subsection{Tests}
During the sprint, the team executed a total of seven test cases. An example of a testcase can be seen in \autoref{tab:STID08} while the rest of the  test cases can be found in \autoref{sec:testcases}.The following list shows the test cases executed this sprint:
\begin{itemize}
	\item TID08 - Supporting \glspl{member} of type \gls{enum}
	\item TID09 - Supporting \glspl{member} of type \gls{array}
	\item TID10 - Supporting the display of \glspl{struct} within \glspl{struct}
	\item TID11 - Supporting \glspl{enumerated named value}
	\item TID12 - Supporting \glspl{bit string}
	\item TID13 - Supporting \glspl{struct} with various \gls{trailers}
	\item TID14 - Sprint 2 functionality test
\end{itemize}
...
%----------------------------
The results are listed in \autoref{tab:sp2TIDS}.

\begin{table}[htbp] \footnotesize \center
\caption{Sprint 1 test results\label{tab:sp2TIDS}}
\noindent\makebox[\textwidth]{%
\begin{tabularx}{\textwidth}{l X}
	...
	\midrule
	Test ID & TID10 \\
	Explanation & Supporting the display of sctructs within \glspl{struct} \\
