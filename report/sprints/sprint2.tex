...
and are not \glspl{struct}. The only way to support this, is to write a own \gls{dissector} 
in \Gls{lua}, and include it in the configuration. 
...
\subsubsection{What \glspl{header} should the \gls{utility} be generate \glspl{dissector} for}
