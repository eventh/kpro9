...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	How & When the cparser module detects a \gls{struct} in the AST that has a \gls{struct} \gls{member}, the cparser searches for its definition in the 
		...
		struct\_field object inside the prototype object corresponding to the outer \gls{struct}. \\
...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	How & The administrator opens the user documentation and finds the section about configuration. Then he locates the section about \gls{bit string}
	 values. This section gives a good description of how to write such configuration, and the administrator is able to implement his desired configuration
	after reading through once and looking at the examples.  \\
...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	This section gives a good description of how to write such configuration. There should also be some
...
\begin{figure}[!htb]
	...
	\caption{Sprint 2 Burndown Chart\label{fig:sp2:burndown}}
\end{figure}
