...
\begin{itemize}
	\item TID08 - Supporting members of type enum \autoref{tab:TID08}
	\item TID09 - Supporting members of type array  \autoref{tab:TID09}
	\item TID10 - Supporting the display of structs within structs  \autoref{tab:TID10}
	\item TID11 - Supporting enumerated named values  \autoref{tab:TID11}
	\item TID12 - Supporting bit strings  \autoref{tab:TID12}
	\item TID13 - Supporting structs with various trailers \autoref{tab:TID13}

\subsection{Test Results}
%----------------------------
\begin{table}[!htb] \footnotesize \center
\caption{Recognizing Supporting enums \label{tab:sp1_tid08}}
\begin{tabular}{l l}
	\toprule
	Header & Description \\
	\midrule
...
\begin{table}[!htb] \footnotesize \center
\caption{Recognizing Supporting arrays \label{tab:sp1_tid09}}
\begin{tabular}{l l}
	\toprule
	Header & Description \\
	\midrule
