...
%----------------------
The utility is able to support struct that has ASN.1 trailers, encoded with 
BER\footnote{Basic Encoding Rules}. Trailers are data that follows a struct, 
this can be any kind of data, but our dissectors currently only support ASN.1. 
The utility is able to configure these data.  In \autoref{code:trailer}, we 
