...
%subsection{Tests}
During the sprint the team executed a total of 7 test cases. The test cases can be found in \autoref{sec:testcases}. Here is a list of the executed test cases:
\begin{itemize}
...
\begin{table}[htbp] \footnotesize \center
\caption{Test case results\label{tab:sp2TIDS}}
\noindent\makebox[\textwidth]{%
\begin{tabularx}{1.2\textwidth}{l X}
	\toprule
	Header & Description \\
