...
%----------------------
The utility is able to support struct that has various trailers. Trailers is data that follows a struct, this can be any kind of data. The utility is able to configure these data.
TODO: Not finished
