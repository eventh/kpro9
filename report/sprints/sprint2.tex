...
%----------------------
The utility is able to support struct that has various trailers. Trailers is 
...
%----------------------
The utility support custom handling of different data types, this includes 
functionallity to support  time\_t and nstime\_t. Alle basic data types and 
struct members can be configured to be handled in special way. 
...
a size of four bytes. The struct member ''all' is configured with a enumrated 
