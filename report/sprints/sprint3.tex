...
%-----------------------
\label{sec:sp3:test}
During sprint 3 the team executed a total of 11 test cases, but no additional testing features were added during the sprint. The test cases executed in this sprint can be found in \autoref{sec:testcases}. The tests executed can be found below:
