...
%-----------------------
During sprint 3 the team executed a total of 9 tests were run. Tests executed:

\begin{itemize}
	\item TID15 - Supporting batch mode of C header and configuration files \autoref{tab:TID15}
	\item TID16 - Supporting custom Lua configuration \autoref{tab:TID16}
	\item TID17 - Supporting unions \autoref{tab:TID17}
	\item TID18 - Supporting filter and search in wireshark \autoref{tab:TID18}
	\item TID19 - Supporting WIN32, \_WIN64, \_SPARC etc \autoref{tab:TID19}
	\item TID20 -  Supporting the use of flags specifying platforms to display member values correctly \autoref{tab:TID20}
	\item TID21 - Supporting platforms with different endians \autoref{tab:TID21}
	\item TID22 - Supporting alignments \autoref{tab:TID22}
\end{itemize}
