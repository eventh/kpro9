...
\begin{tabularx}{1.2\textwidth}{l X}
	...
	The \gls{dissector} module shall have a function that calculates the offset for each field to align it, and functions that create fields for specific \gls{endianness}. \\
...
\begin{table}[htbp] \footnotesize \center
\caption{Sprint 3 test results part 1\label{tab:sp3:testres1}}
\noindent\makebox[\textwidth]{%
...
\begin{table}[htbp] \footnotesize \center
\caption{Sprint 3 test results part 2\label{tab:sp3:testres2}}
\noindent\makebox[\textwidth]{%
\begin{tabularx}{\textwidth}{l X}
	\toprule
	Header & Description \\
