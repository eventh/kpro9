...
\begin{tabularx}{\textwidth}{l l X c c}
	...
	\cmidrule(r){4-5}
	User story & Req. & Description & Est. & Act. \\
	\midrule
	\ref{tab:req:stories7} & FR5-A & Flags specified for each platform & \underline{ 5 } & - \\
	\addlinespace
	\ref{tab:req:stories7} & FR5-C & Dissector support both little and big endian & \underline{ 5 } & - \\
	\addlinespace
	10 & FR5-D &  Dissector support different sizes from flags & \underline{ 11 } & 0.5 \\
	\addlinespace
	 & FR6-C & & \underline{ 7 } & 4.5 \\
	\addlinespace
	 & FR4-C &  & \underline{ 5 } & 3 \\
	\addlinespace
	 &  &  & \underline{ 26 } & 25.5 \\
