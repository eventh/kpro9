...
\begin{tabularx}{\textwidth}{l X c c}
	...
	\hyperref[tab:req:stories7]{US29} & FR5-B: \Glspl{dissector} support memory alignement & 4 & 6.5\\
	\hyperref[tab:req:stories7]{US26} & FR1-D: Support members of type \gls{union} & 5  & 6\\
	\hyperref[tab:req:stories7]{US27} & FR2-A add: Display a wildcard type for valid c types that \Gls{wireshark} has no support for & 3  & 1.5\\
	...
	\hyperref[tab:req:stories9]{US37} & FR5: Create developer manual from python docstrings (autodoc plugin) & 4 & 7 \\
	\addlinespace
...
We can expect to get a greater amount of feedback on the utility when they can test it themselves.
...
The burndown chart for the sprint can be seen in \autoref{fig:sp3:burndown}. The estimated and actual hours fits almost perfectly. This is something we have been good at in all the sprints, but now it is perfected.
\begin{figure}[!htb]
