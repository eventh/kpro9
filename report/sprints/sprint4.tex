...
\begin{tabularx}{\textwidth}{l X c c}
	...
	\hyperref[tab:req:stories12]{US54} & User documentation for unknown struct size configuration & 1 & - \\
	\hyperref[tab:req:stories12]{US56} & User documentation for generating only struct with valid ID or dependencies & 1 & - \\
	\hyperref[tab:req:stories]{US} & Which platforms that the utility support & 2 & - \\
	\hyperref[tab:req:stories]{US} & How to define new platforms to support & 1 & - \\
	\hyperref[tab:req:stories]{US} & Create developer manual from python docstrings & 2 & - \\
	\midrule
	& Total: & 109 &  -\\
	\bottomrule
\end{tabularx}
