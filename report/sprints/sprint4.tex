...
When cparser have parsed all the header files, it startes the generation of all the Lua dissectors. To do this generation the StructVisitor class depends on four modules, config, platform, dissector and field.
