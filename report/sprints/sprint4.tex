...
\begin{tabularx}{\textwidth}{l X c c}
	...
	\hyperref[tab:req:stories8]{US34} & Update command line interface doc & 1 & - \\
	\hyperref[tab:req:stories9]{US36} & Which platforms that the utility support & 2 & - \\
	\hyperref[tab:req:stories9]{US37} & How to define new platforms to support & 1 & - \\
	\hyperref[tab:req:stories9]{US37} & Create developer manual from python docstrings & 2 & - \\
	\hyperref[tab:req:stories9]{US37} & User documentation for the new features added in sprint 4 & 5 & - \\
	\midrule
	& Total: & 109 &  -\\
	\bottomrule
\end{tabularx}
