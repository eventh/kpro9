...
\begin{tabularx}{\textwidth}{l X c c}
	...
	US42 & FR3-E: Find include dependencies which are not explicitly set & 16  & 11 \\
	...
	US52 & FR4-H: Auto generate configuration files for \glspl{struct} without a config file & 1  & 0.5\\
	US51 & FR4-I: Allow configuration of size for unknown \glspl{struct} & 4 & 1 \\
	US43 & FR6-E: Support \Gls{c} macros from \gls{cli} & 1 & 1 \\
	US54 & FR6-F: Only generate \glspl{dissector} for \glspl{struct} with valid a id and their dependencies & 4 & 1.5 \\
	\addlinespace
