...
Process feedback (suggestions for sprint 4)
...
FR3-A Support #include directives
...
FR3-C The utility shall support platform specific C macroes
...
FR4-D Support for the #pragma directive.
...
Only generate useful dissectors
...
Set a compile flag from the command line
...
Multiple message ID’s for one dissector
...
SRCCFG 1 Pick out doxygen commets for descriptions of struct members
...
SRCCFG 2 Read int-enum configuration form the header files
...
Guess the dissector from packed size
...
A way to ignore headers in a specified folder
...
Non functional requirement agreement
Testing on Sparc
...
NR4 Testing user documentation on a person with Wireshark and C experience
...
NR5 Testing user documentation on a person without experience with Wireshark, but with some C experience.
