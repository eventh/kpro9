...
The need for preprocessing C files before they are parsed have become so comprehensive, that we decided to create a dedicated module for it. All the existing cpp concerned code was relocated, joint with the new implementation. Requirements in the sprint backlog (REF?) made it necessary to have more functionality regarding the preprocessor step.   
