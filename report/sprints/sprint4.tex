...
\begin{tabularx}{\textwidth}{l X c c}
	...
	\hyperref[tab:req:stories13]{US56} & FR2-E: Guess \gls{dissector} from \gls{packet} size & 5 & - \\
	...
	\hyperref[tab:req:stories12]{US51} & FR4-I: Allow configuration of size for unknown \glspl{struct} & 4 & - \\
	\hyperref[tab:req:stories10]{US43} & FR6-E: Support \Gls{c} macros from \gls{cli} & 1 & 1 \\
	\hyperref[tab:req:stories12]{US54} & FR6-F: Only generate \glspl{dissector} for \glspl{struct} with valid a id and their dependencies & 4 & - \\
	\addlinespace
	...
	\hyperref[tab:req:stories12]{US53} & User documentation for \gls{struct} size configuration & 1 & - \\
	\hyperref[tab:req:stories12]{US55} & User documentation for generating only \gls{struct} with valid ID or dependencies & 1 & - \\
...
\begin{itemize}
	...
	\item TID45 - Running the utility on Solaris \autoref{tab:sp4TID45}
	\item TID46 - Running the dissectors on Solaris \autoref{tab:sp4TID46}
	\item TID47 - Running the dissectors on Windows \autoref{tab:sp4TID47}	
\end{itemize}
