...
def main():
    ...
    parser = argparse.ArgumentParser(description='Needs to parse commands given when the program is started, and supply them to other parts of the program who needs them.')
